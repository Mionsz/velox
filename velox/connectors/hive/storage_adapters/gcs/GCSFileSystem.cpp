...
void GCSFileSystem::rename(std::string_view, std::string_view, bool) {
  VELOX_UNSUPPORTED("NOT IMPLEMENTED: GCSFileSystem::rename");
}

void GCSFileSystem::mkdir(std::string_view path) {
  VELOX_UNSUPPORTED("NOT IMPLEMENTED: GCSFileSystem::mkdir");
}

void GCSFileSystem::rmdir(std::string_view path) {
  VELOX_UNSUPPORTED("NOT IMPLEMENTED: GCSFileSystem::rmdir");
}
