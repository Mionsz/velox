  ...
  try {
    ...
    EXPECT_EQ(
        ...
        std::string(
            ...
            " SDK Error Type:, GCS Status Code:Resource not found, "
            " Message:'Permanent error GetObjectMetadata:"
            " {\"error\":{\"code\":404,\"message\":\"{\\\"error\\\": {\\\"errors\\\":"
            " [{\\\"domain\\\": \\\"global\\\", \\\"message\\\":"
            " \\\"Live version of object test1-gcs/newTest.txt does not exist.\\\"}]}}\"}}\n'"));
  }
}
